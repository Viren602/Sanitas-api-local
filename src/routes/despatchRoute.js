...
despatchRoute.post("/Despatch/UpdateSalesOrderProforma", checkAuth, updateSalesOrderProforma);
despatchRoute.get("/Despatch/GenerateProformaInvoice", generateProformaInvoice);
