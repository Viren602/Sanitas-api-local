...
import { addEditDeliveryChallan, addEditGSTInvoiceFinishGoods, addEditInvoicePM, addEditInvoiceRM, addEditInwardPost, addEditOutwardPost, addEditSalesGoodsReturnEntry, addEditSalesOrderEntry, cancelEInvoiceById, deleteInvoiceById, deleteInwardPostById, deleteItemDeliveryChallanById, deleteItemFromDBById, deleteOtherDeliveryChallanById, deleteOutwardPostById, deletePMInvoiceById, deletePMItemFromDBById, deleteRMInvoiceById, deleteRMItemFromDBById, deleteSalesGoodsReturnById, deleteSalesGoodsReturnItemById, deleteSalesOrderById, deleteSalesOrderItemByItemId, generateEInvoiceById, generateEwayBill, generateGSTInvoiceForFinishGoodsById, generateGSTInvoiceForPMById, generateGSTInvoiceForRMById, getAllBatchesForItemByItemId, getAllBatchWiseStockStatementReport, getAllGSTInvoiceFinishGoodsRecords, getAllGSTInvoicePMRecords, getAllGSTInvoiceRMRecords, getAllInwardOutwardRegister, getAllInwardPost, getAllItemWiseDesptach, getALLItemWiseMonthlySales, getAllNearExpiryStockReport, getAllOrderDetailsItemMappingById, getallOtherDeliveryChallanList, getAllOutwardPost, getAllPartyWiseDespatchItem, getAllPartyWiseDespatchItemById, getAllPartyWiseMonthlySalesByPartyId, getAllSalesGoodsReturnEntry, getAllSalesOrderEntry, getAllStockLedgerReport, getAllStockLedgerReportBatchStock, getALLStockStatementByProductId, getAllStockStatementReport, getCompanyAddressByCompanyId, getGSTInvoiceFinishGoodsById, getGSTInvoiceFinishGoodsInvoiceNo, getGSTInvoicePMById, getGSTInvoicePMInvoiceNo, getGSTInvoiceRMById, getGSTInvoiceRMInvoice, getInwardPostById, getOtherDeliveryChallanDetailsById, getOutwardPostById, getPakcingMaterialStockByPMID, getProductionStockByProductId, getrawMaterialStockByRMId, getSalesGoodsReturnDetailsById, getSalesGoodsReturnEntryInvoiceNo, getSerialNoForDeliveryChallan, printOtherDeliveryChallanById, sendGSTInvoiceFinishGoodsToClient, sendGSTInvoicePMToClient, sendGSTInvoiceRMToClient } from "../controller/despatchController.js";
...
despatchRoute.get("/Despatch/SendGSTInvoiceFinishGoodsToClient", sendGSTInvoiceFinishGoodsToClient);
despatchRoute.get("/Despatch/GenerateEInvoiceById", checkAuth, generateEInvoiceById);
despatchRoute.post("/Despatch/GenerateEwayBill", checkAuth, generateEwayBill);
despatchRoute.post("/Despatch/CancelEInvoiceById", checkAuth, cancelEInvoiceById);
...
// Despatch - Other Delivery Challan
despatchRoute.get("/Despatch/GetSerialNoForDeliveryChallan", checkAuth, getSerialNoForDeliveryChallan);
despatchRoute.post("/Despatch/AddEditDeliveryChallan", checkAuth, addEditDeliveryChallan);
despatchRoute.post("/Despatch/GetallOtherDeliveryChallanList", checkAuth, getallOtherDeliveryChallanList);
despatchRoute.get("/Despatch/GetOtherDeliveryChallanDetailsById", checkAuth, getOtherDeliveryChallanDetailsById);
despatchRoute.get("/Despatch/DeleteItemDeliveryChallanById", checkAuth, deleteItemDeliveryChallanById);
despatchRoute.get("/Despatch/DeleteOtherDeliveryChallanById", checkAuth, deleteOtherDeliveryChallanById);
despatchRoute.get("/Despatch/PrintOtherDeliveryChallanById", printOtherDeliveryChallanById);
...
// Despatch -Inaward Outward Post report 
despatchRoute.post("/Despatch/GetAllInwardOutwardRegister", checkAuth, getAllInwardOutwardRegister);
