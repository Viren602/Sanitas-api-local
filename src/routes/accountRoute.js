...
accountRoute.get("/Account/GetLastPurchaseRawmaterialRate", checkAuth, getLastPurchaseRawmaterialRate);
...
accountRoute.post("/Account/GetAllPendingInvoicePaymentReport", checkAuth, getAllPendingInvoicePaymentReport);
...
accountRoute.post("/Account/GetGSTCalculationList", checkAuth, getGSTCalculationList);
